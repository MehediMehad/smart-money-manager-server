...
router.get('/', auth('USER', 'ADMIN'), CategoriesControllers.getCategories);

router.get('/default', auth('USER', 'ADMIN'), CategoriesControllers.defaultCategories);

router.post('/hide/:categoryId', auth('USER', 'ADMIN'), CategoriesControllers.hideCategory);
